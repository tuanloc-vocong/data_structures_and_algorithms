 ...
 *
 * Do trên lớp không nghe giảng kỹ nên hai cậu đã quên mất các quy tắc xác định xem một năm có phải là năm nhuận hay không.
 * Bạn hãy viết một chương trình giúp hai cậu ấy nhé.
 *
 * Input:
