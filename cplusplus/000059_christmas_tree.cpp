 ...
 * được sinh ra. Và một biểu tượng không thể thiếu trong ngày lễ Giáng sinh chính là cây thông Noel. Là một
 * người học lập trình bạn hãy đón lễ Giáng sinh theo phong cách “IT” bằng cách viết một chương trình in ra cây
 * thông Noel.
 *
 * Input:
